    ...
    <body>
      ...
      <div class="section">
        ...
        <table>
          ...
          <tr>
            <td>Total Efectivo Sistema</td>
            <td class="text-right">${formatMoney((resumen.resumen.totalVentas || 0) - ((resumen.resumen.totalTransferencia || 0) + (resumen.resumen.totalNequi || 0)))}</td>
          </tr>
          <tr>
