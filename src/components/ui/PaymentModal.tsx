...
const styles = StyleSheet.create({
  ...
  estadoContainer: { paddingHorizontal: 20, paddingTop: 8 },
  estadoSectionTitle: { fontSize: 11, fontWeight: '800', color: '#9ca3af', letterSpacing: 1.5, marginBottom: 12, textAlign: 'center' },
  estadoScrollContent: { paddingRight: 20, gap: 8, flexDirection: 'row' },
